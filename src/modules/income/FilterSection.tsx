  ...
  return (
    ...
    >
      ...
      >
        ...
        <FormItemCustom label={t("income.filter.type")} name="incomeAndExpenseType">
          <Select
        ...
        <FormItemCustom label={t("income.filter.documentDateFrom")} name="documentDateFrom">
          <DatePicker className="w-full md:!w-[150px]" />
        </FormItemCustom>

        <FormItemCustom label={t("income.filter.documentDateTo")} name="documentDateTo">
          <DatePicker className="w-full md:!w-[150px]" />
        </FormItemCustom>
